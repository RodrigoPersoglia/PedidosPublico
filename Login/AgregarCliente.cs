...
namespace Login
{
	public partial class AgregarCliente : Form
	{
		...
		private void Crear_Click(object sender, EventArgs e)
		{
			...
			{
				Conexion.CrearCliente(DirFisc_Txt.Text, (int)LocFis_Cbx.SelectedValue,CPFisc.Text, DirEntrega_txt.Text, (int)LocEnt_Cbx.SelectedValue,CPEnt.Text, (int)NumCliente.Value, Alias_Txt.Text, RazonSocial_Txt.Text, (long)NumDoc.Value, Tel1_tex.Text, Tel2_text.Text, (int)TipoDoc_Cbx.SelectedValue, (int)IVA_Cbx.SelectedValue);
				// Limpiar datos
