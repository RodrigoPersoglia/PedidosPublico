    ...
    public partial class Aleacion : Form
    {
        ...
        private void Agregar_Click(object sender, EventArgs e)
        {
            if ( descripcionTBX.Text != "" )
            {
                ...
                catch (Exception) { MessageBox.Show("No se pudo agregar la Aleacion, revise los datos y reintente"); }
            }
        ...
        private void ModificarBTN_Click(object sender, EventArgs e)
        {
            if (descripcionTBX.Text != "")
            {
                ...
                catch (Exception) { MessageBox.Show("No se pudo modificar la Aleacion, revise los datos y reintente"); }
            }
            else { MessageBox.Show("Revise los campos ingresados"); }
        }
