...
namespace Login
{
	public partial class ModificarCliente : Form
	{
		...
		private void Crear_Click(object sender, EventArgs e)
		{
			...
			{
				Conexion.ModificarCliente(clienteSeleccionado.ID, int.Parse(NumCli.Text), Alias_Txt.Text,RazonSocial_Txt.Text,decimal.ToInt32(NumDoc.Value),Tel1_tex.Text,Tel2_text.Text,(int)TipoDoc_Cbx.SelectedValue,(int)IVA_Cbx.SelectedValue,DirFisc_Txt.Text,(int)LocFis_Cbx.SelectedValue,CPFisc.Text,DirEntrega_txt.Text,(int)LocEnt_Cbx.SelectedValue,CPEnt.Text);
				// Limpiar datos
				NumCli.Text = "";
